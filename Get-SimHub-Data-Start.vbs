...
startCommand = "powershell.exe -ExecutionPolicy Bypass -NoLogo -NonInteractive -WindowStyle Hidden -File " & Chr(34) & scriptPath & Chr(34) & " -Start -DataDir " & Chr(34) & dataDir & Chr(34)
...
createResult = processClass.Create(startCommand, Null, startupConfig, processId)
...
If createResult <> 0 Then
	...
	logFile.WriteLine "[" & Now & "] [VBS] COMMAND " & startCommand
	logFile.Close
	Set logFile = Nothing
End If
